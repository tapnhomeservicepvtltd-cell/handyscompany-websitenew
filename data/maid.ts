...
export const maidDetailsList: ServiceDetail[] = [
  ...
  // Added from New Catalog Suggestions
...
export const maidDetails: Record<string, ServiceDetail> = maidDetailsList.reduce((acc, item) => {
  acc[item.id] = item;
  return acc;
}, {} as Record<string, ServiceDetail>);

export const maidServices = maidDetailsList;
export const homeMaidServices = maidDetailsList.slice(0, 8);
export const allMaidServices = maidDetailsList;
