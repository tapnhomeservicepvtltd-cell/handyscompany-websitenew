...
export const plumbingDetailsList: ServiceDetail[] = [
...
export const plumbingDetails: Record<string, ServiceDetail> = plumbingDetailsList.reduce((acc, item) => {
  acc[item.id] = item;
  return acc;
}, {} as Record<string, ServiceDetail>);

export const plumbingServices = plumbingDetailsList;
