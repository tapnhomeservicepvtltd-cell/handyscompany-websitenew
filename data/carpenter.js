...
exports.carpenterServices = exports.carpenterDetails = exports.carpenterDetailsList = void 0;
const createCarpenterService = (config) => ({
    rating: 4.8,
    reviewsCount: 520,
    duration: "45-60 Mins",
    visitCharge: 49,
...
exports.carpenterDetails = exports.carpenterDetailsList.reduce((acc, item) => {
    acc[item.id] = item;
    return acc;
}, {});
exports.carpenterServices = exports.carpenterDetailsList;
exports.default = exports.carpenterServices;
