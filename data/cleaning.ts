...
export const cleaningServicesList: (ServiceItem & ServiceDetail)[] = [
...
export const cleaningDetails: Record<string, ServiceDetail> = cleaningServicesList.reduce((acc, item) => {
  acc[item.id] = item;
  return acc;
}, {} as Record<string, ServiceDetail>);

export const cleaningServices: ServiceItem[] = cleaningServicesList;
